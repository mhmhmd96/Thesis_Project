...
hostsList = {331:93, 332:215, 1911:93, 1912:215,
	     1951:87, 1952:137, 91:87, 92:137,
	     }

update_time = 400
hard = str(update_time+50)
...
def hostThread(client, server, threasnum, priority):
	...
	paths = {
	331:'7::3', 332: '8::3', 1911:'7::4', 1912:'8::4',
	1951:'9::5', 1952:'17::5', 91:'9::6', 92:'17::6',
	141:'3::7', 47:'3::8', 176:'5::9', 139:'5::17'}
...
def permenant_flows():
	...
	for client, server in hostsList.items():
		...
		thread = Thread(target = hostThread, args= (client, server, threasnum1, priority1))
		#thread.start()
		threasnum+=4
